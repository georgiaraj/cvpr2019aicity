...
In order to train our model, we combine both training sets, $\mathcal{I}_1$ and $\mathcal{I}_2$, and employ batches that contain both images with and without orientation labelling.
...
\begin{table}
  ...
  \begin{tabular}{l || c | c | c }
    ...
    MTCRO (no ReRank) \cite{xu2018framework} & 61.6 & 87.2 & 94.2 \\
