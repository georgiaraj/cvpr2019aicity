...
%
Specially, vehicle re-identification (re-ID) attracted increasing attentions in community
\cite{liu2016vehicleid,Liu2016cvpr_drdl,liu2016veri,Liu2016eccv_veri,
...
Vehicle re-identification task aims at searching a specific vehicle
...
\cite{gong2014re,chen2017person,Li2018Harmonious,xiao2016learning,
...
(1) Unlike person re-id, pose/orientation of vehicles results in self occlusion and drastic visual geometry changes, since vehicle is a kind of rigid body.
...
due to the similar even same vehicle model. This requires the vehicle re-id model
...
% Our contributions
In this work, we propose a noval mutual learning based network architecture,
that aims to simultaneously learn a number of tasks, plus a consensus, to build an
